  ...
  return (
    <div className="max-w-[1520px] mx-auto flex justify-between items-center p-4">
      <div className="flex items-center">
        ...
        <div className="bg-gray-200 rounded-full ml-6 flex items-center px-2 w-[200px] sm:w-[400px] lg:w-[800px]">
        ...
        <button className="bg-orange-700 text-white ml-6 hidden md:flex items-center py-2 rounded-full ">
      ...
      >
        ...
        <nav>
          <ul className="flex flex-col p-4 text-gray-900">
            <li className="text-xl p-4 flex cursor-pointer">
              <BsPerson
                size={25}
